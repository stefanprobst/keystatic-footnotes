...
export function FootnotesSection(props: FootnotesSectionProps) {
	...
	return (
		<section className="border-t py-4">
			...
			<ol className="grid gap-y-3 text-sm">
	...
	return (
		<div id={createFootnoteContentId(count)}>
			...
			<a className="ml-1.5" href={`#${createFootnoteReferenceId(count)}`}>
				<ArrowLeftSquareIcon
					aria-hidden={true}
					className="inline size-4 shrink-0 stroke-1 align-sub text-neutral-500 transition hover:text-neutral-950 dark:hover:text-neutral-0"
				/>
